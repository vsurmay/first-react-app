const data = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        category: "Dessert",
        timeForDone: "2 hours",
        description: "Creamy and delicious strawberry cheesecake.",
        ingredients: [
    ...
    items: [
      {
        ...
        description: "A refreshing lemonade with mint.",
        ingredients: ["lemon", "water", "sugar", "mint"],
        recipe:
          "1. Squeeze the juice from 4 lemons into a pitcher.\n2. Add 4 cups of water and 1 cup of sugar to the pitcher and stir until the sugar dissolves.\n3. Add a handful of fresh mint leaves to the pitcher and stir.\n4. Chill the lemonade in the refrigerator for at least 30 minutes before serving.",
      ...
      },
      {
        ...
        description: "A simple yet delicious iced tea.",
        ingredients: ["tea bags", "water", "sugar", "lemon"],
        recipe:
          "1. Boil 4 cups of water in a pot.\n2. Remove the pot from the heat and add 4 tea bags.\n3. Steep the tea for 5 minutes.\n4. Remove the tea bags and add 1/2 cup of sugar to the pot. Stir until the sugar dissolves.\n5. Let the tea cool to room temperature, then chill it in the refrigerator for at least 1 hour.\n6. Cut a lemon into slices and add them to the tea before serving.",
    ...
    items: [
      {
        ...
        recipe:
          "1. Cook pasta according to the package instructions. Reserve 1 cup of pasta cooking water. \n2. In a saucepan, heat olive oil over medium heat. Add garlic and cook until fragrant. \n3. Add heavy cream and Parmesan cheese. Stir until the cheese has melted and the sauce is smooth. \n4. Add cooked pasta to the saucepan and stir to combine. \n5. Add reserved pasta cooking water as needed to thin out the sauce. \n6. Serve immediately and enjoy!",
      ...
      },
      {
        ...
        recipe:
          "1. Preheat oven to 425°F. \n2. Rinse the chicken and pat it dry with paper towels. \n3. In a bowl, mix softened butter, minced garlic, lemon zest, salt, and black pepper. \n4. Carefully loosen the skin of the chicken and spread the butter mixture under the skin. Rub the remaining butter mixture over the outside of the chicken. \n5. Place the chicken in a roasting pan and roast for 50-60 minutes, until the internal temperature reaches 165°F. \n6. Let the chicken rest for 10 minutes before carving. \n7. Serve with your favorite sides and enjoy!",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        recipe:
          "1. Preheat the oven to 350°F (175°C). \n2. Slice the baguette into pieces. \n3. Melt the butter and mix in the chopped garlic. \n4. Brush the garlic butter onto the bread. \n5. Bake in the oven for 10-12 minutes or until crispy and golden brown.",
        name: "Garlic Bread",
      },
    ],
  },
